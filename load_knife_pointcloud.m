...
load('C:\Users\jiajun\Documents\MyNutCloud\008-LaserKnife\001-demo\背光源刀具mat数据(人工旋转_反色)\im_canny_0625.mat');
% 密集点云
[idx1_x, idx1_y] = find(I1_canny == 1);
[idx2_x, idx2_y] = find(I2_canny == 1);
